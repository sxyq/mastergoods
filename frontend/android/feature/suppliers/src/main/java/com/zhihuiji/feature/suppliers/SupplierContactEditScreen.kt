...
@Composable
fun SupplierContactEditScreen(
    supplierId: Long,
    contactId: Long?,
    onNavigateBack: () -> Unit,
    onSaveSuccess: () -> Unit,
    modifier: Modifier = Modifier,
    viewModel: SupplierContactEditViewModel = hiltViewModel(),
) {
    val uiState by viewModel.uiState.collectAsStateWithLifecycle()

    LaunchedEffect(supplierId, contactId) {
        if (contactId != null) viewModel.loadContact(supplierId, contactId)
    }
    ...
    Column(modifier = modifier.fillMaxSize()) {
        ...
        if (uiState.isLoading) {
            ...
            BottomActionBar(
                ...
                onPrimaryClick = { viewModel.save(supplierId, contactId) },
