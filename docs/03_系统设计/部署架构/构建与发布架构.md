...
| Web | `VITE_PUBLIC_BASE=/zhj/ VITE_API_BASE_URL=https://zhj-api.sxyq27.online npm run build`（`Code/frontend/web/`） | `tmp/build/web/dist/`（2026-08-30 通过） |
...
- 部署产物（tmp/build）：哈希一致；管理员发布记录见 `testing/admin/20260830-production-deployment.md`。
