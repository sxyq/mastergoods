...
| Flyway | V40，PostgreSQL 15，40 个迁移校验通过 |
...
flowchart LR
    ...
    G --> C[容器 sxyq27-zhj-api:20260830T052508-admin-c2d9040c-dirty-fix2]
    C --> S[Spring Boot 127.0.0.1:18080]
    S --> P[(PostgreSQL 15 Flyway V40)]
...
- 未完成内容：无
- Blocked 内容：8220 无业务数据，管理员真实业务链路待夹具
- Deferred 内容：多模态
