...
| 依据测试 | `testing/Agent/功能测试/TEST_PLAN.md`、`AgentSseClientCancellationTest.kt`、`AgentStreamEventSerializationTest.kt` |
...
对应测试：`AgentStreamEventSerializationTest.kt`、`testing/Agent/功能测试/TEST_PLAN.md`。
...
- 功能测试：`testing/Agent/功能测试/TEST_PLAN.md`（流式对话）
