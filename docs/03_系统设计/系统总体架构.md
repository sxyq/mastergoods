...
- 容器：`sxyq27-zhj-api`，镜像 `sxyq27-zhj-api:20260830T052508-admin-c2d9040c-dirty-fix2`，回滚镜像 `rollback-20260830T052508-admin-c2d9040c-dirty`。
- 应用端口映射：`127.0.0.1:18080`。
- 公共入口：`https://zhj-api.sxyq27.online/`（未鉴权 403）。
- 数据库：PostgreSQL 15，Flyway V40。
- Web 管理端：124 Nginx 的 `https://sxyq27.online/zhj/`，API 直连 `https://zhj-api.sxyq27.online/`。
