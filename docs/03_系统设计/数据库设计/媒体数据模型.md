...
| 当前状态 | 已完成 |
| 适用端 | 后端 |
| 依据源码 | `resources/db/migration/V13__media_and_agent_expansion.sql`、`domain/entity/MediaAssetEntity.java`、`MediaBindingEntity.java`、`infrastructure/storage/MediaStorageService.java`、`LocalMediaStorageService.java` |
| 依据测试 | `V2MediaServiceTest.java`、`V2AgentMediaControllerTest.java` |
