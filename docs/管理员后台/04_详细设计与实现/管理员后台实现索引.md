...
| 独立管理员 Web 发布与基础验收 | 已完成（基础范围） | release `c012290b` 已发布至 `https://sxyq27.online/zhj-admin/`；公网入口、SPA 路由、JS/CSS 资源返回 200，登录页可见且浏览器控制台错误为 0；未认证 `/v2/admin/session` 返回 401 |
