...
- Controller、Service、Repository、DTO、权限解析、管理员审计、配置、导出、保留策略和 Agent 观测后端已上线并完成核心只读 HTTP 验证。
- 临时原型的数字、用户、门店、模型和日志内容仍为脱敏演示数据；独立 Web 的跨 owner/store 页面、SSE 重连、性能和恢复演练待验证。
