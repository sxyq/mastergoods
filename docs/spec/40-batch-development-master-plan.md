...
| AI 助手视觉与流程贴合 | 待验证 | 任务/通知页状态标签已改为统一 `StatusPill`，避免 feature 私有状态组件长期存在 | Agent 域页面达到设计稿级别 | `31`、android `feature/agent` |
