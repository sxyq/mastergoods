...
final class DashboardViewModel: ObservableObject {
    @Published var kpis: [KPIBlock] = [
        KPIBlock(id: "sales", title: "销售额", value: "¥0.00", subtitle: "等待真实接口"),
        KPIBlock(id: "receivable", title: "待收款", value: "¥0.00", subtitle: "等待真实接口"),
        KPIBlock(id: "stock", title: "退款", value: "¥0.00", subtitle: "等待真实接口"),
        KPIBlock(id: "cash", title: "订单数", value: "0", subtitle: "等待真实接口"),
    ]
    ...
    func load(using client: APIClient) async {
        ...
        do {
            let summary = try await client.fetchSalesSummary(startAt: range.startAt, endAt: range.endAt)
            kpis = [
                ...
                KPIBlock(id: "orders", title: "订单数", value: "\(summary.totalOrderCount)", subtitle: "今日成交单据"),
            ]
            errorMessage = nil
        } catch {
