...
const webRoot = resolve(repositoryRoot, 'Code/frontend/web')
const stitchRoot = resolve(webRoot, 'public/stitch_exports')
const centralizedBuildOutput = resolve(repositoryRoot, 'tmp/build/web/dist')
