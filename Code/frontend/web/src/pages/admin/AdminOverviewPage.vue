...
const metricConfig: Record<string, { label: string; icon: typeof UsersRound }> = { users: { label: '用户总数', icon: UsersRound }, stores: { label: '门店总数', icon: Store }, agentRuns: { label: 'Agent 运行', icon: Bot }, toolCalls: { label: '工具调用', icon: Activity }, totalTokens: { label: 'Token 总量', icon: Database } }
