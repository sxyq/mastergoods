...
import com.zhihuiji.core.database.migration.Migration5To6
import com.zhihuiji.core.database.migration.Migration6To7
import com.zhihuiji.core.database.migration.Migration7To8
import com.zhihuiji.core.database.migration.Migration8To9
import com.zhihuiji.core.database.migration.Migration9To10
import com.zhihuiji.core.database.migration.Migration10To11
...
object DatabaseModule {
    ...
    @Provides
    fun provideSyncOutboxDao(db: ZhihuijiDatabase) = db.syncOutboxDao()

    @Provides
    fun provideSyncRemoteRecordDao(db: ZhihuijiDatabase) = db.syncRemoteRecordDao()
