...
public class CreateInventoryAdjustmentTool extends ToolSupport {
    ...
    public JsonNode parameterSchema() {
        ...
        addIntegerProperty(schema, "product_id", "商品 ID");
        addNumberProperty(schema, "quantity", "调整数量，正数入库，负数出库，不能为 0", null);
        addStringProperty(schema, "product_name", "商品名称，用于展示");
        addStringProperty(schema, "reason", "调整原因");
        addRequired(schema, "product_id", "quantity");
        return schema;
    }
