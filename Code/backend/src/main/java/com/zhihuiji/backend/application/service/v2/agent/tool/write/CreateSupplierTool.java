...
public class CreateSupplierTool extends ToolSupport {
    ...
    public JsonNode parameterSchema() {
        ...
        addStringProperty(schema, "name", "供应商名称");
        addStringProperty(schema, "phone", "供应商手机号");
        addIntegerProperty(schema, "group_id", "供应商分组 ID");
        addStringProperty(schema, "remark", "供应商备注");
