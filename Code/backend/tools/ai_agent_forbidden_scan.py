...
DEFAULT_PATHS = [
    "Code/backend/src/main/java/com/zhihuiji/backend/api/controller/v2/V2AgentController.java",
    "Code/backend/src/main/java/com/zhihuiji/backend/application/service/v2",
    "Code/backend/src/main/java/com/zhihuiji/backend/infrastructure/ai",
    "Code/backend/src/main/java/com/zhihuiji/backend/api/dto/v2/agent",
    "Code/backend/src/main/java/com/zhihuiji/backend/infrastructure/repository",
    "Code/frontend/android/feature/agent",
    "Code/frontend/android/data/agent",
    "Code/frontend/android/core/model/src/main/java/com/zhihuiji/core/model/v2/agent",
...
def self_test() -> None:
    sample = classify("Code/frontend/android/feature/agent/src/main/java/com/zhihuiji/feature/agent/AgentChatScreen.kt", 'placeholder = "输入经营问题"')
    assert sample[0] == "pass", sample
    sample = classify("Code/backend/src/main/java/com/zhihuiji/backend/application/service/v2/V2AgentAiService.java", "fake stream")
