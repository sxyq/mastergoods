...
${ROOT_DIR}/Code/frontend/android/feature/agent/src/main/java/com/zhihuiji/feature/agent/AgentChatViewModel.kt:627:            delay(48)
${ROOT_DIR}/Code/frontend/android/feature/agent/src/main/java/com/zhihuiji/feature/agent/AgentChatScreen.kt:951:                placeholder = "输入经营问题，AI 会查询真实业务数据...",
EOF
...
${ROOT_DIR}/Code/backend/src/main/java/com/zhihuiji/backend/application/service/v2/V2AgentAiService.java:9999:chunkSize = 8
EOF
...
capture_forbidden_scan() {
  local dir="$1"
  {
    ...
    rg -n \
      ...
      "${ROOT_DIR}/Code/frontend/android/feature/agent/src/main" \
      "${ROOT_DIR}/Code/frontend/android/data/agent/src/main" \
      "${ROOT_DIR}/Code/frontend/android/core/network/src/main" \
      "${ROOT_DIR}/Code/frontend/android/core/model/src/main/java/com/zhihuiji/core/model/v2/agent" \
      "${ROOT_DIR}/Code/backend/src/main/java/com/zhihuiji/backend/application/service/v2" \
      "${ROOT_DIR}/Code/backend/src/main/java/com/zhihuiji/backend/api/controller/v2" \
      "${ROOT_DIR}/Code/backend/src/main/java/com/zhihuiji/backend/api/dto/v2/agent" | sort || true
