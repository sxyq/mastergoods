...
public class CustomerProfileLookupTool extends ToolSupport {
    ...
    public String description() {
        return "根据客户余额、订单、收款方式和退货记录生成客户画像与跟进建议";
    }
    ...
    public ToolResult execute(ToolContext ctx, JsonNode params) {
        ...
        String answer = "客户「" + safeText(customer.getName(), "-") + "」累计销售额 " + money(totalSalesAmount)
            + "，当前欠款 " + money(balance) + "，最近收款 " + money(totalReceivedAmount)
            + "，付款习惯偏" + paymentHabit + "。" + collectionSuggestion;
