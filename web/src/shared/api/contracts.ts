...
export const endpointCatalog = {
  ...
  partners: [
    ...
    api('GET', '/v2/customer-contacts', '客户联系人列表', 'archives:view', ['customer_contacts']),
    api('POST', '/v2/customer-contacts', '新增客户联系人', 'archives:write', ['customer_contacts']),
    api('PUT', '/v2/customer-contacts/{id}', '编辑客户联系人', 'archives:write', ['customer_contacts']),
    api('DELETE', '/v2/customer-contacts/{id}', '删除客户联系人', 'archives:write', ['customer_contacts']),
    api('GET', '/v2/supplier-contacts', '供应商联系人列表', 'archives:view', ['supplier_contacts']),
    api('POST', '/v2/supplier-contacts', '新增供应商联系人', 'archives:write', ['supplier_contacts']),
    api('PUT', '/v2/supplier-contacts/{id}', '编辑供应商联系人', 'archives:write', ['supplier_contacts']),
    api('DELETE', '/v2/supplier-contacts/{id}', '删除供应商联系人', 'archives:write', ['supplier_contacts']),
  ],
  sales: [
  ...
  finance: [
    ...
    api('GET', '/v2/accounts/{id}', '读取资金账户详情', 'finance:view', ['accounts']),
    api('PUT', '/v2/accounts/{id}', '编辑资金账户', 'finance:write', ['accounts']),
    api('DELETE', '/v2/accounts/{id}', '删除资金账户', 'finance:write', ['accounts']),
    api('GET', '/v2/account-transfers', '账户转账列表', 'finance:view', ['account_transfers']),
    api('GET', '/v2/account-transfers/{id}', '读取转账详情', 'finance:view', ['account_transfers']),
    api('POST', '/v2/account-transfers', '创建账户转账', 'finance:write', ['account_transfers', 'accounts']),
  ...
  agent: [
    ...
    api('GET', '/v2/agent/drafts/pending', '读取待确认 AI 草稿', 'agent:view', ['agent_drafts']),
    api('POST', '/v2/agent/drafts/{id}/confirm', '确认 AI 草稿并执行创建', 'agent:write', ['agent_drafts']),
    api('POST', '/v2/agent/drafts/{id}/cancel', '取消 AI 草稿', 'agent:write', ['agent_drafts']),
  ...
  media: [
    api('GET', '/v2/media/assets', '媒体资源列表', 'archives:view', ['media_assets']),
    api('GET', '/v2/media/assets/{id}', '读取媒体资源详情', 'archives:view', ['media_assets']),
    api('GET', '/v2/media/assets/{id}/content', '读取媒体资源二进制内容', 'archives:view', ['media_assets']),
    api('POST', '/v2/media/assets', '新增媒体资源元数据', 'archives:write', ['media_assets']),
    api('POST', '/v2/media/assets/upload', '上传媒体文件', 'archives:write', ['media_assets']),
    api('DELETE', '/v2/media/assets/{id}', '删除媒体资源', 'archives:write', ['media_assets']),
    api('GET', '/v2/media/bindings', '媒体绑定列表', 'archives:view', ['media_bindings']),
    api('POST', '/v2/media/bindings', '创建媒体绑定', 'archives:write', ['media_bindings']),
    api('DELETE', '/v2/media/bindings/{id}', '删除媒体绑定', 'archives:write', ['media_bindings']),
  ],
  rbac: [
...
export const routeContractKeys: Record<string, (keyof typeof endpointCatalog)[]> = {
  ...
  '/finance/accounts/edit': ['finance'],
  '/finance/transfers': ['finance'],
  '/archives/contacts': ['partners'],
