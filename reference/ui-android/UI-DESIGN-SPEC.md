...
> 说明：本文档描述历史工程的视觉规范，源工程已删除，完整实现见 archive/pre-domain-rewrite（tag pre-domain-rewrite-2026-09-25）；文中指向 `DEVELOPMENT-PLAN.md`、`../web/public/stitch_exports/`、`docs/design-mockups/` 的链接均已随旧工程失效。

> 本文件不再以 `docs/design-mockups/01.png ~ 08.png` 作为唯一视觉真源。
> 当前 Android UI 的正式重构基线以：
>
> - 当前 Android 开发计划：[`DEVELOPMENT-PLAN.md`](./DEVELOPMENT-PLAN.md)
> - [stitch manifest.tsv](../web/public/stitch_exports/visual-design_system_framework_14840154594131085259/manifest.tsv)
>
> 为准。
